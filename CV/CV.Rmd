...
aboutme: 五年美国顶尖智库数字经济政策研究及数据分析经验，发表英文研究报告和综述30余篇，主要研究方向涉及数字经济时代产业动态、区域经济发展政策、高新技术创业环境等。熟练运用 Stata, R, Python 等工具进行数据分析、数据建模、和数据可视化。
# aboutme: Experienced urban economics researcher at a leading think tank, with 30+ publications on sustainable infrastructure, economic impact of technology, and access to capital. Provided consultation for five regional economic development organizations on sectoral strategies. 
